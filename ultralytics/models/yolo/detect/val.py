...
class DetectionValidator(BaseValidator):
        ...
        for si, pred in enumerate(preds):
            ...
            if npr == 0:
                if nl:
                    ...
                    # ---------------------- mIOU --------------------- #
                    # if self.args.plots:
                    #     self.confusion_matrix.process_batch(detections=None, gt_bboxes=bbox, gt_cls=cls) # 修改mIOU时注释的两行
                continue
            ...
            if nl:
                ...
                # if self.args.plots:
                #     self.confusion_matrix.process_batch(predn, bbox, cls) # 修改mIOU时注释的两行
                # ---------------------- mIOU --------------------- #
    ...
    def calculate_miou(self):
        ...
        valid_classes = [class_idx for class_idx in range(self.nc) if
                         self.class_iou[class_idx] is not None and self.class_iou[class_idx] != 0.0]
